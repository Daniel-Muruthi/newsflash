...
def get_news():
    ...
    '''
    get_news_url = 'http://newsapi.org/v2/everything?q=politics&sortBy=relevancy&pageSize=10&page=1&apiKey=08db512f09b84c36a7d6f33d72d82fad'.format()
...
def search_news(topic):
    get_news_details_url = 'http://newsapi.org/v2/everything?q={}&pageSize=24&apiKey=08db512f09b84c36a7d6f33d72d82fad'.format(topic)
